                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="flex items-baseline space-x-4">
                            ...
                            <Link to="/about" className="text-stone-300 hover:bg-zinc-700/50 hover:text-white hover:font-semibold px-3 py-2 rounded-md text-lg font-normal tracking-wide transition duration-300">About</Link>
