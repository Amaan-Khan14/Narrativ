...
// .wrangler/tmp/bundle-xg3mOJ/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/amaan/Projects/Hono-projects/Narrativ/server/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/amaan/Projects/Hono-projects/Narrativ/server/prisma/schema.prisma"
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
...
// node_modules/@amaank14/narrativ-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@amaank14/narrativ-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-xg3mOJ/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-xg3mOJ/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// routes/user.ts
var import_narrativ_common = __toESM(require_dist());
...
userRouter.post("/signup", async (c) => {
  ...
  const { success, error } = import_narrativ_common.signUpSchema.safeParse(body);
  if (!success)
    return c.json({ message: "Invalid body", error: error.issues }, 400);
  if (!body) {
...
userRouter.post("/signin", async (c) => {
  ...
  const body = await c.req.json();
  const { success, error } = import_narrativ_common.signInSchema.safeParse(body);
  if (!success)
    return c.json({ message: "Invalid body", error: error.issues }, 400);
  if (!body) {
    return c.json({ error: "No body" }, 400);
  ...
  try {
    ...
    return c.json({ message: "Some Error Occured", error: error2 }, 400);
  }
});
...
var import_narrativ_common2 = __toESM(require_dist());
...
blogrouter.post("/", async (c) => {
  ...
  const body = await c.req.json();
  const { success, error } = import_narrativ_common2.createBlogSchema.safeParse(body);
  if (!success)
    return c.json({ message: "Invalid body", error: error.issues }, 400);
...
blogrouter.delete("/:id{[0-9]+}", async (c) => {
  ...
  try {
    ...
    return c.json({ message: "Blog deleted", blog });
  } catch (error) {
